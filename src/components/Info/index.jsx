    ...
    <div className={[styles.info, styles.section_padding].join(" ")}>
      <div className={styles.info_heading}>
        ...
        <p>
          ...
          <b>open-source packaging ecosystem and philosophy</b>. This ecosystem
          is supported by many organizations who all share the common goal of{" "}
          <b>providing easier access to programming tools and libraries</b>.
        </p>
      </div>
    </div>
  );
