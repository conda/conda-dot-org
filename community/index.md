...
The conda community also had a Discourse instance. This forum is now retired (use [Zulip][conda-zulip] instead), but valuable information can still be found in its threads.
