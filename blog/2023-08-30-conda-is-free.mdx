...
import whatsfree from '@site/static/img/blog/2023-08-30-conda-is-free/whatsfree.png';

<Image img={whatsfree} alt="Banner image: graphic summarizing what parts of the ecosystem are free versus paid. "/>

<p>
    <i>
        <small>
            Image credit: <a href="https://www.anaconda.com/blog/is-conda-free">Is conda free?</a>
        </small>
    </i>
</p>
...
A new blog post, titled "[**Is `conda` Free?**](https://www.anaconda.com/blog/is-conda-free)", answers the your questions about:
