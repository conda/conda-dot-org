...
image: img/blog/2025-12-19-conda-meta-mcp/banner.jpg
---
...
[**conda-meta-mcp**](https://github.com/conda-incubator/conda-meta-mcp) is an **MCP (Model Context Protocol) server** that exposes authoritative, read-only conda ecosystem metadata directly to AI agents.
...
3. Agent searches the conda-meta-mcp codebase for zipfile usage
   → No imports of zipfile found

4. Agent concludes: "CVE-2025-8291 is present in the installed Python version,
   but conda-meta-mcp does not use the zipfile module. The vulnerable code
