...
The server is built with [FastMCP](https://github.com/jlowin/fastmcp) for minimal boilerplate and uses [pixi](https://pixi.sh/) for fast, reproducible dependency management.
