...
And this thought provoking post from Ralk Gommers earlier this year:
...
* **[conda-lock 2.0](https://github.com/conda/conda-lock/releases/)** - A lightweight library for generating fully reproducible lock files for conda environments.
