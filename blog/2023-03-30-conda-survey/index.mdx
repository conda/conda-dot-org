...
import surveyImagePreferred from './img/conda-is-my-preferred-package-manager.png';
import surveyImageDataFormats from './img/data-formats-top.png';
import surveyImageDataViz from './img/data-visualization-tools-top.png';
import surveyImageDatabases from './img/databases-top.png';
import surveyImageDesired from './img/desired-conda-changes.png';
import surveyImageEtl from './img/etl-tools-top.png';
import surveyImageSatisfied from './img/i-am-satisfied-with-conda.png';
import surveyImageAccess from './img/i-can-access-my-desired-packages.png';
import surveyImageIntegrate from './img/i-can-integrate-conda-with-my-workflow.png';
import surveyImageIndustries from './img/industries-top.png';
import surveyImageJobs from './img/job-function-top.png';
import surveyImageLanguages from './img/programming-languages-top.png';
import surveyImagePsfAgree from './img/psf-how-much-do-you-agree-with-these-statements.png';
import surveyImagePsfForAll from './img/psf-what-should-the-packaging-system-do-to-be-an-ecosystem-for-all.png';
import surveyImagePsfTools from './img/psf-which-python-packaging-tools-do-you-use.png';
import surveyImageStats from './img/statistical-analysis-top.png';
import surveyImageTopPackages from './img/top-5-packages.png';
import surveyImageApplications from './img/what-types-of-applications-do-you-use-conda-in-top.png';
import surveyImageAdditional from './img/which-additional-package-managers-do-you-use-top.png';
...
[<Image img={surveyImagePreferred} alt="conda is my preferred package manager" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1699334366)
[<Image img={surveyImageAccess} alt="I can access my desired packages" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1192657027)
[<Image img={surveyImageIntegrate} alt="I can integrate conda with my workflow" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1595912193)
[<Image img={surveyImageSatisfied} alt="I am satisfied with conda" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1582523399)
...
[<Image img={surveyImageDesired} alt="Desired conda changes" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1229097249)
...
[<Image img={surveyImageAdditional} alt="Which additional package managers do your use, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1102296811)
...
<Image img={surveyImagePsfTools} alt="PSF: Which Python packaging tools do you use?" />
...
<Image img={surveyImagePsfForAll} alt="What should the packaging ecosystem do to be an ecosystem for all" />
...
<Image img={surveyImagePsfAgree} alt="How much do you agree with these statements?" />
...
[<Image img={surveyImageIndustries} alt="Top industries" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1700458323)
...
[<Image img={surveyImageApplications} alt="What types of applications do you use conda in?" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1170448145)
...
[<Image img={surveyImageTopPackages} alt="Top 5 packages" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=968125862)
...
[<Image img={surveyImageLanguages} alt="Programming languages, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=681062781)
...
[<Image img={surveyImageDataFormats} alt="Data formats, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1927071597)
...
[<Image img={surveyImageDatabases} alt="Databases, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1314196509)
...
[<Image img={surveyImageStats} alt="Statistical analysis tools, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1524339820)

Microsoft Excel (35%) and R (31%) were the two most popular tools in the statistical analysis tools category.

[<Image img={surveyImageEtl} alt="ETL Tools, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1574024089)
[<Image img={surveyImageDataViz} alt="Data visualization tools, top" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1532616702)
...
[<Image img={surveyImageJobs} alt="Job functions" />](https://docs.google.com/spreadsheets/d/1rpWN6atSEsALvStPtAVIf_WMTxXXKaDKYpKRsvMpbOo/edit#gid=1839470285)
