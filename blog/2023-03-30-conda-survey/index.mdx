...
<Image img={surveyImagePsfTools} alt="Bar chart from PSF survey: Which Python packaging tools do you use? Raw data is not available." />
...
<Image img={surveyImagePsfForAll} alt="Line chart from PSF Survey: What should the packaging ecosystem do to be an ecosystem for all. Raw data is not available." />
...
<Image img={surveyImagePsfAgree} alt="Stacked bar chart from PSF survey: How much do you agree with these statements? Raw data not available." />
