...
<a href="https://condastats.readthedocs.io/en/latest/try/" className="button button--primary button--lg" style={{display: "block", textAlign: "center"}}>Open the condastats demo →</a>
</div>
...
- **Try the browser demo:** [condastats.readthedocs.io](https://condastats.readthedocs.io/en/latest/tryit.html)
...
Originally created by [Sophia Man Yang](https://github.com/sophiamyang), condastats is now maintained by the [conda-incubator](https://github.com/conda-incubator) community.
