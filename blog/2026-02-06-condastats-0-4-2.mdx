...
The demo is part of the [condastats documentation](https://condastats.readthedocs.io) on ReadTheDocs and fetches package data from GitHub Pages. It loads about 20 MB of Pyodide plus 1--15 MB of Parquet data per queried month.
