...
Throughout this tutorial, we'll show you how to install and run PostgreSQL from [conda-forge][conda-forge] using [conda][conda-docs], [mamba][mamba-docs] (or [micromamba][micromamba-docs]), or [pixi][pixi]. Please refer to those projects' documentation for information on how to install them.
...
<Tabs>
  ...
  <TabItem value="mamba" label="(micro)mamba">

    To create a new environment with PostgreSQL, run the following command:
