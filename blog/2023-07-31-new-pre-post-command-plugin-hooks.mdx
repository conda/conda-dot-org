...
[conda-schutz]: https://github.com/travishathaway/conda-schutz
...
To check out a fully functional example, check out the [conda-schutz][conda-schutz] project
...
The project linked to above is called [`conda-schutz`](https://github.com/travishathaway/conda-schutz)
("schutz" roughly translates to "guard" in German 😀🇩🇪), and it extends conda by adding functionality 
to "guard" a conda environment from being changed. Sometimes users may want to do this to protect themselves
...
def conda_schutz_pre_commands_action(command: str) -> None:
...
def conda_pre_commands():
    yield plugins.CondaPreCommand(
        name=f"conda_schutz_pre_command",
        action=conda_schutz_pre_commands_action,
...
For the full implementation, please see the [conda-schutz][conda-schutz] project.
...
[conda-schutz][conda-schutz] project. This project can also be used as a starting template
for your plugins.
