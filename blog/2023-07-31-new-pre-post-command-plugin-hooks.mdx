...
To see a fully-functioning example of how to use these new hooks, please check out the [conda-guard
project][conda-guard].

<!-- truncate -->

To explain how these plugin hooks can be used, we walk through two examples.
...
_For the full implementation please see https://github.com/travishathaway/conda-guard_
...
ENV_COMMANDS = {"env_config", "env_create", "env_export", "env_list", "env_remove", "env_update"}
