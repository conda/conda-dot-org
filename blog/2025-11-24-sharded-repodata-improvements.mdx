---
title: "Conda users will soon get a 10x speed-up for repodata fetching"
slug: "sharded-repodata-improvements"
authors: [travishathaway]
tags: [conda, performance]
description: "Using conda is now significantly faster with improvements made to repodata fetching. Learn how we did it and who helped along the way."
...
that improves the overall speed of conda. This will initially be rolled out for the
[conda-forge](https://conda-forge.org) channel with other channels following soon.
We'll initially be releasing this as an opt-in beta feature, and in this post, we'll talk
...
- [anaconda.org](https://anaconda.org) team at Anaconda worked with the conda-forge community to enable the hosting
  infrastructure to serve the new sharded format.
...
- Under both scenarios, we see 10x speed-up in fetching and parsing of repodata
