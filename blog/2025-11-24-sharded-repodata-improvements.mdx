...
- [anaconda.org](https://anaconda.org) team at Anaconda worked with the conda-forge community to enable the hosting. We plan to work with other channels to add support as the beta progresses.
