...
- [@tkelman](https://github.com/tkelman) made their first contribution in [conda-build#5565](https://github.com/conda/conda-build/pull/5565)
- [@ypradat](https://github.com/ypradat) made their first contribution in [conda-build#5560](https://github.com/conda/conda-build/pull/5560)
