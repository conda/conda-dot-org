...
This first article sets the stage by exploring the difference between **library registries** and **distributions**, and why comparing conda to pip is like comparing apples to entire orchards.
