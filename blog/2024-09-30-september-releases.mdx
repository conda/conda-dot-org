...
- Tweak pending deprecation warning for the upcoming changes in channel defaults.
...
- Remove deprecated testing entrypoint `shell/bin/conda`. Use `dev/start[.bat]` instead.
