...
image_credit: <a href="https://unsplash.com/de/fotos/zerbrochenes-glas-mit-dunklem-verschwommenem-hintergrund-04jpFiARLmY?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Scar Tissue on Unsplash</a>
---
...
- Non-sharded fetching always has to fetch the same sized repodata but
  ...
  the requested packages as seen here.
