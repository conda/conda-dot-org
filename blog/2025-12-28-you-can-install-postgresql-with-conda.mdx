...
Throughout this tutorial, we'll show you how to install and run PostgreSQL from [conda-forge][conda-forge] using either [conda][conda-docs] or [pixi][pixi]. Please refer to those projects' documentation for information on how to install them.
